class RecipeIndexViewHelper {
    private static readonly PARTIAL_VIEW_ID = "partialView";
    private static readonly RECIPE_SIDEBAR_SEARCH_URL = "/Recipe/SideBarSearch";
    private static readonly RECIPE_SIDEBAR_ADD_TO_MENU_URL = "/Recipe/AddRecipeToMenu";
    private static readonly RECIPE_SIDEBAR_REMOVE_FROM_MENU_URL = "/Recipe/RemoveRecipeFromMenu";    
    private static readonly RECIPE_SIDEBAR_DELETE_URL = "/Recipe/DeleteRecipe";
